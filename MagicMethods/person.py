class Persona:
    ...
    def __str__(self) -> str:
        #Devuelve una representacion amigable para el usuario
    ...
    def __eq__(self, otra_persona) -> bool:
        #Compara si dos personas son iguales en funcion del nombre y la edad
        return self.nombre == otra_persona.nombre and self.edad == otra_persona.edad
    
    def __lt__(self, otra_persona) -> bool:
        #Compara si una persona es "menor" que otra en funcion de la edad
